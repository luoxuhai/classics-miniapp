    ...
    <view class="page-body uni-content-info">
          ...
          <view class="uni-corpper-content"
            ...
            <view class="uni-corpper-crop-box"
              ...
              <view class="uni-cropper-view-box">
                ...
                <view class="uni-cropper-line-t"
                      data-drag="top"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-line-r"
                      data-drag="right"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-line-b"
                      data-drag="bottom"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-line-l"
                      data-drag="left"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-point point-t"
                      data-drag="top"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-point point-tr"
                      data-drag="topTight"></view>
                <view class="uni-cropper-point point-r"
                      data-drag="right"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-point point-rb"
                      data-drag="rightBottom"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-point point-b"
                      data-drag="bottom"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"
                      @touchend.stop="dragEnd"></view>
                <view class="uni-cropper-point point-bl"
                      data-drag="bottomLeft"></view>
                <view class="uni-cropper-point point-l"
                      data-drag="left"
                      @touchstart.stop="dragStart"
                      @touchmove.stop="dragMove"></view>
                <view class="uni-cropper-point point-lt"
      ...
      <view class='cropper-config'>
        <div class="button-succ"
             ...
             hover-class="hover-button"> 完成 </div>
        <div class="button-exit"
             @click="exitCropImg"
             style='margin-top: 30rpx;'
             hover-class="hover-button"> 取消 </div>
      </view>
        ...
        success: function success(res) {
          ...
          if (IMG_RATIO >= 1) {
            ...
            _this.setData({
              ...
              imageW: IMG_REAL_W,
              imageH: IMG_REAL_H,
              scaleP: (IMG_REAL_W / SCREEN_WIDTH) * 2,
              qualityWidth: DRAW_IMAGE_W,
...
.uni-corpper {
  ...
  /*当你点击一个链接或者通过Javascript定义的可点击元素的时候，它就会出现一个半透明的灰色背景。要重设这个表现*/
...
.uni-corpper-crop-box .uni-cropper-view-box {
  ...
  height: 100%;
  overflow: visible;
  outline: 1rpx solid #355c7d;
  outline-color: rgba(53, 92, 125, 0.75);
}
/* 横向虚线 */
